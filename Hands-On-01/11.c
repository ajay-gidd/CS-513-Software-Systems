...
{
    int oldfd = open("Test.txt",O_RDWR);
    if(oldfd == -1){
    ...
    const char* append = "Hi, Ajay from oldfd\n";
    ...
    const char* append2 = "Hi Ajay from dupfd\n";
    ...
    const char* append3 = "Hi this Ajay from dupfd2\n";
    ...
    const char* append4 = "Hi this Ajay from fcntl\n";
